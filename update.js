...
const ANALISIS = {
  ...
  "Tunisia_Japan":          {ganador:"Japón favorito. Empató 2-2 con Países Bajos al 89'. Túnez goleado 1-5.",goleadores:"Daichi Kamada (Japón) — marcó el 2-2 al 89'. Ritsu Doan peligroso.",figura:"Takumi Minamino (Japón) — motor junto a Kamada.",apuesta:"Japón gana · Más de 1.5 goles · Kamada anota. Cuota est: 2.2x"},
  ...
  "Uruguay_Cabo Verde":     {ganador:"Uruguay igualó 1-1 con Arabia (Araújo 80'). Cabo Verde empató 0-0 con España sorprendiendo.",goleadores:"Darwin Núñez (Uruguay) — el más peligroso.",figura:"Federico Valverde (Uruguay) — motor del equipo celeste.",apuesta:"Uruguay gana · Darwin Núñez anota. Cuota est: 2.1x"},
  ...
  "England_Ghana":          {ganador:"Inglaterra goleó 4-2 a Croacia. Ghana ganó 1-0 a Panamá al 94'. Inglaterra favorita.",goleadores:"Harry Kane (Inglaterra) — doblete J1. Mohammed Kudus (Ghana) peligro africano.",figura:"Jude Bellingham (Inglaterra) — puede marcar la diferencia.",apuesta:"Inglaterra gana · Kane anota · Más de 2.5 goles. Cuota est: 1.8x"},
...
async function main() {
  ...
  const continenteHTML = '<div style="background:linear-gradient(135deg,#0a1f2f,#0d1a3a);border:1px solid #1a3a5a;border-radius:12px;padding:13px 15px;margin-bottom:20px;">'
    ...
    + '<div style="background:rgba(167,139,250,0.06);border-radius:8px;padding:10px 12px;border:1px solid rgba(167,139,250,0.15);"><div style="font-size:11px;font-weight:700;color:#c4b5fd;margin-bottom:5px;">🌏 ASIA Y OCEANÍA</div><div style="font-size:11px;color:#cbd5e1;line-height:1.8;"><b style="color:#4ade80;">Destacados:</b> Japón (2-2 Países Bajos al 89'), Corea del Sur (2-1 remontada).<br/><b style="color:#f87171;">Flojos:</b> Qatar (0-6 vs Canadá), Arabia Saudita (1-1).<br/><b style="color:#fbbf24;">Veredicto:</b> Japón y Corea siguen siendo los mejores de Asia.</div></div>'
